document.addEventListener("DOMContentLoaded", () => {
  ...
  const botaoInfo = document.querySelector(".btn.info").parentElement; 
  ...
  function trocarFilme(img) {
    ...
    const novoLink = img.dataset.link || "/html/detalhesFilme.html";
    ...
    setTimeout(() => {
      ...
      botaoInfo.setAttribute("href", novoLink); // muda o link do botão
